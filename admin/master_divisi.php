...
<html lang="en">
    <head>
        ...
        <title>Divisi- SIA COFFE SHOP</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Master Data Divisi</h1>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody id="data_divisi">
                                        <?php
                                        // Query data divisi dari database
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            echo "<tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href='delete_divisi.php?divisi={$row['id_divisi']}' class='btn btn-danger btn-sm' onclick=\"return confirm('Are you sure you want to delete this divisi?')\">Delete</a>
                                                </td>
                                            </tr>";
                                        }
                                        ?>
            ...
            document.querySelectorAll('.btn-update').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    const id_divisi = row.cells[0].innerText;
                    const nama_divisi = row.cells[1].innerText;
                    const deskripsi_divisi = row.cells[2].innerText;

                    // Isi modal dengan data yang diambil
                    document.getElementById('editiddivisi').value = id_divisi;
                    document.getElementById('editNama').value = nama_divisi;
                    document.getElementById('editDeskripsi').value = deskripsi_divisi;

                    // Tampilkan modal
                    var editModal = new bootstrap.Modal(document.getElementById('editDivisiModal'));
                    editModal.show();
                });
            });
            </script>
