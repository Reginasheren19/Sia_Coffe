...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO master_akun (kode_akun, nama_akun, kategori, jenis_saldo) 
            VALUES ('$kode_akun', '$nama_akun', '$kategori', '$jenis_saldo')";

    // Eksekusi query
    if (mysqli_query($koneksi, $sql)) {
        echo "<script>alert('Data berhasil ditambahkan!'); window.location.href='master_akun.php';</script>";
    } else {
...
<div class="container mt-4">
    <h1 class="mb-4">Master Data Akun</h1>
